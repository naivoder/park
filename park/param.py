...
parser.add_argument(
    "--logging_level", type=str, default="info", help="logging level (default: info)"
)
parser.add_argument(
    "--log_to",
    type=str,
...
# -- Load balance --
parser.add_argument(
    "--num_servers", type=int, default=10, help="number of servers (default: 10)"
)
parser.add_argument(
    "--num_stream_jobs",
    type=int,
...
parser.add_argument(
    ...
    nargs="+",
    help="workers service rates "
    "(default: [0.15, 0.25, 0.35, 0.45, 0.55, 0.65, 0.75, 0.85, 0.95, 1.05])",
)
parser.add_argument(
    "--job_interval", type=int, default=55, help="job arrival interval (default: 55)"
)
parser.add_argument(
    "--job_size_pareto_shape",
    type=float,
    default=1.5,
...
parser.add_argument(
    "--aqm_step_num", type=int, default=300, help="total number of steps (default: 300)"
)
parser.add_argument(
    "--aqm_step_interval",
    type=int,
...
parser.add_argument(
    "--aqm_uplink_trace",
    type=str,
    default="park/envs/aqm/mahimahi/trace10",
...
# -- Spark --
parser.add_argument(
    "--exec_cap", type=int, default=50, help="Number of total executors (default: 50)"
)
parser.add_argument(
    "--num_init_dags",
    type=int,
...
parser.add_argument(
    "--qopt_viz", type=int, default=0, help="visualizations per episode"
)
...
parser.add_argument(
    "--qopt_train_runtime", type=int, default=0, help="train using runtimes from DB"
)
...
parser.add_argument(
    "--qopt_query", type=int, default=0, help="index of the query to run"
)
parser.add_argument(
    "--qopt_train",
    type=int,
...
parser.add_argument(
    "--qopt_only_attr_features", type=int, required=False, default=1, help=""
)

parser.add_argument(
    "--qopt_reward_normalization",
    type=str,
    required=False,
    default="min_max",
...
parser.add_argument(
    "--qopt_cost_model", type=str, required=False, default="rowCount", help=""
)
parser.add_argument("--qopt_dataset", type=str, required=False, default="JOB", help="")
parser.add_argument("--qopt_clear_cache", type=int, required=False, default=0, help="")
parser.add_argument(
    "--qopt_recompute_fixed_planners", type=int, required=False, default=0, help=""
)

# -- Cache --
parser.add_argument(
    "--cache_trace", type=str, required=False, default="test", help="trace selection"
)
parser.add_argument(
    "--cache_size", type=int, required=False, default=1024, help="size of network cache"
)
parser.add_argument(
    "--cache_unseen_recency",
    type=int,
    required=False,
    default=500,
...
parser.add_argument(
    "--ss_load", type=float, default=0.9, help="Load of the system (default: 0.9)"
)

# -- Device Placement for Tensorflow --
parser.add_argument(
    "--pl_graph", type=str, default="inception", help="The tensorflow graph to place"
)
parser.add_argument(
    "--pl_n_devs",
    type=int,
...
# -- Congestion Control --
parser.add_argument(
    "--cc_delay", type=int, default=25, help="Link delay to run experiment with"
)
parser.add_argument(
    "--cc_uplink_trace", type=str, default="const48.mahi", help="Uplink trace to use"
)
parser.add_argument(
    "--cc_downlink_trace", type=str, default="const48.mahi", help="Uplink trace to use"
)
parser.add_argument(
    "--cc_duration", type=int, default=120, help="How long of an experiment to run"
)
